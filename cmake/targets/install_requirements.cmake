...
if     (VERSION_OF_MDBOOK_SVGBOB STREQUAL "[none]")
    set(CRATE_OF_MDBOOK_SVGBOB "")
elseif (VERSION_OF_MDBOOK_SVGBOB STREQUAL "")
    set(CRATE_OF_MDBOOK_SVGBOB "mdbook-svgbob")
else()
    set(CRATE_OF_MDBOOK_SVGBOB "mdbook-svgbob@${VERSION_OF_MDBOOK_SVGBOB}")
endif()
remove_cmake_message_indent()
message("")
message("VERSION_OF_MDBOOK              = ${VERSION_OF_MDBOOK}")
message("VERSION_OF_MDBOOK_I18N_HELPERS = ${VERSION_OF_MDBOOK_I18N_HELPERS}")
message("VERSION_OF_MDBOOK_SVGBOB       = ${VERSION_OF_MDBOOK_SVGBOB}")
message("CRATE_OF_MDBOOK                = ${CRATE_OF_MDBOOK}")
message("CRATE_OF_MDBOOK_I18N_HELPERS   = ${CRATE_OF_MDBOOK_I18N_HELPERS}")
message("CRATE_OF_MDBOOK_SVGBOB         = ${CRATE_OF_MDBOOK_SVGBOB}")
message("")
execute_process(
...
message(STATUS "Running 'cargo install' command to install the 'mdbook-course' crate...")
if (CMAKE_HOST_LINUX)
    set(ENV_PATH                "${PROJ_CONDA_DIR}/bin:$ENV{PATH}")
    set(ENV_LD_LIBRARY_PATH     "${PROJ_CONDA_DIR}/lib:$ENV{LD_LIBRARY_PATH}")
    set(ENV_CARGO_INSTALL_ROOT  "${PROJ_CONDA_DIR}")
